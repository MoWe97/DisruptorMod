...
import theDisruptor.patches.relics.BottledPlaceholderField;
import theDisruptor.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theDisruptor.DefaultMod.makeRelicOutlinePath;
import static theDisruptor.DefaultMod.makeRelicPath;
